...
/* ------------------------------------------------------------------
   13. NEWSLETTER (fond dark + visuel) + FOOTER complet
   Contact Cameroun, liens, réseaux sociaux, mentions.
------------------------------------------------------------------- */
...
export default function Footer({ settings }) {
  ...
  /* Coordonnées & réseaux gérés depuis le dashboard admin (table settings) */
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      gsap.from(".newsletter__inner > *", {
        ...
        stagger: 0.1,
        ease: "power2.out",
        scrollTrigger: { trigger: ".newsletter", start: "top 82%" },
      });
    }, rootRef);
    return () => ctx.revert();
  }, []);
  ...
  return (
    <footer id="contact" ref={rootRef} className="footer-wrap">
      {/* --- Newsletter --- */}
          ...
          <div className="newsletter__card">
            <div className="newsletter__inner">
              ...
              <h2 className="newsletter__title">
                Des idées digitales, <span className="accent">chaque mois</span>
              </h2>
              <p className="newsletter__sub">
                Conseils concrets, tendances et offres réservées — directement
                dans votre boîte mail. Zéro spam.
              </p>
        ...
        <div className="container-it">
          <div className="footer__grid">
            ...
            <div className="footer__brand">
              ...
              <p>
                Agence web basée au Cameroun. Notre mission : rendre le digital
                accessible à tous, au prix juste.
              </p>
              {/* Réseaux sociaux */}
          ...
          <div className="footer__bottom">
            ...
            <p className="footer__made">
              Fait avec <span aria-hidden="true">❤</span> à Douala
            </p>
          </div>
        </div>
      </div>
