...
/* ------------------------------------------------------------------
   06. CTA BANNIÈRE — fond crème / rouge-soft
   "Prêt à donner de l'impact à votre projet ?" → Discutons-en
   + petits éléments décoratifs (avion papier / étincelles) animés.
------------------------------------------------------------------- */
...
export default function CtaBanner({ settings }) {
  ...
  useLayoutEffect(() => {
    const ctx = gsap.context(() => {
      ...
      /* Entrée de la bannière : léger scale + fade */
      ...
      /* Avion papier : flottement continu */
      gsap.to(".cta-plane", {
        y: "-=10",
        rotation: "+=4",
        duration: 3,
      ...
      /* Étincelles : pulsation décalée */
      gsap.utils.toArray(".cta-spark").forEach((el, i) => {
        gsap.to(el, {
          scale: 0.6,
          opacity: 0.4,
          duration: 1.6,
  ...
  return (
    <section ref={rootRef} className="cta-banner">
      <div className="container-it">
        <div className="cta-banner__card">
          {/* Décor : avion papier + trait pointillé */}
          ...
          <p className="cta-banner__sub">
            Premier échange gratuit, devis sous 48h. Racontez-nous votre idée,
